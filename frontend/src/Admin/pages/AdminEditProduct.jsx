...
export default function AdminEditProduct() {
  ...
  const undoDelete = (i) => {
    setImageItems((prev) =>
      prev.map((item, idx) => (idx === i ? { ...item, deleted: false } : item)),
    );
  };
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 20,
          boxShadow:
            "0 1px 0 rgba(99,102,241,0.06), 0 2px 8px rgba(0,0,0,0.04)",
        }}
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  border: `1px solid ${active ? "rgba(99,102,241,0.4)" : done ? "rgba(99,102,241,0.15)" : T.border}`,
                  background: active
                    ? T.indigoLight
                    : done
                      ...
                      style={{
                        ...
                        background: done
                          ...
                          : active
                            ? T.indigoLight
                            : "#f1f5f9",
                        border: `2px solid ${done ? T.success : active ? T.indigo : "#e2e8f0"}`,
                        color: done ? T.success : active ? T.indigo : T.textDim,
                        boxShadow: active
                  ...
                  {i < STEPS.length - 1 && (
                    <div
                      style={{
                        ...
                        minWidth: 20,
                        background: done
                          ? "linear-gradient(to right, rgba(16,185,129,0.4), rgba(16,185,129,0.2))"
                          : "#e2e8f0",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <strong>{visibleItems.length}</strong> image
                      {visibleItems.length !== 1 ? "s" : ""} total
                    </div>
                    {newFiles.length > 0 && (
                      <div
                        style={{
                    ...
                    {deletedPublicIds.length > 0 && (
                      ...
                      >
                        ...
                        <strong>{deletedPublicIds.length}</strong> will be
                        deleted
                      </div>
                    )}
                  </div>
                  ...
                  <label
                    ...
                    style={{
                      display: "block",
                      border: `2px dashed ${dragOver ? T.indigo : "rgba(99,102,241,0.25)"}`,
                      borderRadius: 14,
                      padding: "30px 24px",
                      textAlign: "center",
                      cursor: "pointer",
                      background: dragOver ? T.indigoLight : "#fafbff",
                      transition: "all 0.2s",
                      marginBottom: 20,
                    }}
                  >
                    ...
                    <p style={{ color: T.textDim, fontSize: 11.5, margin: 0 }}>
                      PNG, JPG — new images will be added alongside existing
                      ones
                    </p>
                    <input
                      type="file"
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    background: "white",
                    border: `1.5px solid ${step === 0 ? T.border : "#e2e8f0"}`,
                    color: step === 0 ? T.textDim : T.textMid,
                    transition: "all 0.2s",
                    boxShadow: step === 0 ? "none" : T.shadow,
                  }}
                >
                  ← Back
                </button>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: submitted
                        ...
                        : "none",
                      color: submitted ? T.success : "white",
                      boxShadow:
                        loading || submitted
                          ? "none"
                          : "0 4px 14px rgba(99,102,241,0.35)",
                ...
                <div style={{ padding: 18 }}>
                  <div
                    style={{
                      ...
                      overflow: "hidden",
                      border: `1px solid ${T.border}`,
                      background: visibleItems.length
                        ? "transparent"
                        : "#f8faff",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    {visibleItems.length ? (
                      ...
                      <div style={{ textAlign: "center" }}>
                        ...
                        <p
                          style={{ fontSize: 10, color: T.textDim, margin: 0 }}
                        >
                          No image
                        </p>
                      </div>
                      ...
                      style={{
                        ...
                        background:
                          completion === 100
                            ...
                            : `linear-gradient(90deg, ${T.indigo}, #a78bfa)`,
                      }}
                    />
                  </div>
                  <div
                      ...
                      >
                        <div
                          style={{
                            ...
                            justifyContent: "center",
                            flexShrink: 0,
                            background: v ? T.successBg : "#f1f5f9",
                            border: `1.5px solid ${v ? "rgba(16,185,129,0.3)" : "#e2e8f0"}`,
                          }}
                        >
                          {v && (
                            <svg
